...
# For fairness in comparison, the accuracy metric implementations are the same as in the
# PBT codebase, supplied in the following paper:
# Onur Yildirim, Sepehr Bakhshi and Fazli Can. Prioritized Binary Transformation Method for Efficient Multi-label
# Classification of Data Streams with Many Labels. Proceedings of the 33rd ACM International Conference on
# Information and Knowledge Management, p. 4218–4222
